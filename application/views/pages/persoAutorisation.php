          ...
          <div class="modal-content" >
            <div class="modal-header" style="background-color: #bb2739;height: 56.5px;">
             ...
             <select class="form-control select2" style="width: 100%;" name="annee_auto" required>
               ...
               <div class="col-9">
               <input type="text"  class="form-control" name="nbjrs_auto" id="nbjrs_auto" placeholder="Nombre de jour demandé" step="1" required>
              </div>         
              <div class="col-9">
          ...
          <div class="modal-content" >
            <div class="modal-header" style="background-color: #bb2839;height: 56.5px;">
             ...
             <div class="col-9">
               ...
               <div class="col-9">
               <input type="text"  class="form-control" id="editnbjr_auto" name="editnbjr_auto" placeholder="Nombre de jour demandé" required>
              </div>         
              <div class="col-9">
               ...
               <!--Chapitre Budgetaire-->
            <div class="modal-footer justify-content-between" style="margin-left: 24%;">
              <button type="button" class="btn btn-flat" style="margin-left: 25%;color: #fff; background-color: #bb2839;" id="btnannulerMod" >Annuler</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button style="background-color: #bb2839;color: #fff;" type="button" id="annulerBntan" class="btn btn-flat" data-dismiss="modal">OK</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button style="background-color: #bb2839;color: #fff;" type="button" id="BtnOkSup" class="btn btn-flat" data-dismiss="modal">OK</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
$('#AnBtn').click(function(){
 $('#annulerAutoEncours').modal('hide');
 });

 $('#btnannulerMod').click(function(){
...
function imprimerAutorisation(id_auto = null) 
{
  if(id_auto) {
document.location.href= '<?php echo base_url();?>control/imprimerAutorisation'+'/' + id_auto;
  }else {
    alert('error');
  }
}
...
function deletedemandeautorisation(id_auto = null) 
{
  if(id_auto) {
    $('#confirmeModalModSup').modal('show');
    $("#BtnOkSup").unbind('click').bind('click', function() {
      $.ajax({
        url: '<?php echo base_url();?>control/deletedemandeautorisation' + '/' + id_auto,
        type: 'post',       
        dataType: 'json',
        success:function(response){
          if(response.success === true) {

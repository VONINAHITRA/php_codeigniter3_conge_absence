...
.ml9 .letter {
  ...
  line-height: 1em;
	...
	<body onload="menu(6);"  onload="change();" class="hold-transition sidebar-mini  layout-navbar-fixed">
		<aside class="main-sidebar sidebar-dark-primary elevation-4" style=" position: fixed;width: 18%;background-color: #fff; color: #000">
    <!-- Sidebar -->
...
<div> <img style="width: 40%;border-radius: 50%;margin-left: 30%;margin-top: 6%;" src="<?php echo base_url('images/menetp.jpg');?>"></div>
   ...
   <div style="width: 40%;margin-top: -7%;">
       <div class="container-fluid" style="width: 250%;">
        <div class="row mb-2">
          <div class="callout callout-men" style="width: 100%;margin-bottom: 0%;">
          	<font color="#0000ff" size="5px"> <u>NOTES</u></font>: <br>
            <font color="#0000ff"> <u>Congé annuel</u></font>:<br>
              30 jours par an, et maximun 15 jours pour chque demandes. <br>
              <font color="#0000ff"> <u>Congé de paternité</u></font>:<br>
               15 jours . 
               <br>
             <font color="#0000ff">  <u>Congé de paternité</u></font>:<br>
               3 mois ou 90 jours . 
               <br>
             <font color="#0000ff">  <u>Permission d'absence</u></font>:<br>
               20 jours par an, et demande maximun est 1 jours. 
               <br>
             <font color="#0000ff">  <u>Autorisation d'absence</u></font>:<br>
               15 jours par an et demande maximun est de 3 jours.
            </div>
        </div>
      </div>
  </div>
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light barres" style="margin-left: -20%;">
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
       ...
       <div class="ml9" style="margin-left: 170%;width: 150%;font-size: 27px;">
   ...
   <div class="btn-group" style="background-color:#bb2939;color: #fff;">
                  <button type="button" class="btn btn-flat" style="background-color: #fff;color:#000;margin-top: -3%; "><i class="fas fa-power-off" style="color:#fff;"></i><?php echo $pseudo_user; ?>&nbsp;&nbsp;&nbsp;</button>
                    ...
                    <div class="dropdown-menu" role="menu">
                      <a class="dropdown-item" href="<?php echo base_url('control/liencompteAdmin'); ?>" style="background-color: #bb2839;color: #fff;margin-bottom: 0.5%;"> <?php echo $email_user; ?></a>
				...
				<button class="b1"> sdq</button><br><button class="b1"> sdq</button><br><button class="b1"> sdq</button><br><button class="b1"> sdq</button>
					<div id="menu"  style="margin-left:50%; ">
						<div id="centre" align="center" valign="middle"></div>
							...
							<li id="item1"><a href="<?php echo base_url('control/lienPersonnelAdmin'); ?>"> <img src="<?php echo(base_url('images/Account-128.png')) ?>" title="Compte d'urilisateur " width="100px" height="100px"/><br><span style="color: #000;font-size: 11px; margin-left: 3px;"><b> Mon compte</b></span></a>

			                <li id="item3"><a href="<?php echo base_url('control/lienAutorisationAdmin'); ?>" ><img src="<?php echo(base_url('images/summary-icon.png')) ?>" title="Autorisation d'absence" width="100px" height="100px"/><br><span style="color: #000;font-size: 11px;margin-left: -10px; ">Autorisation d'absence</span></a>

			              	<li id="item4"><a href="<?php echo base_url('control/lienpermissionAdmin'); ?>" ><img src="<?php echo(base_url('images/images(1).png')) ?>" title="Permission d'absence" width="100px" height="100px"/><br><span style="color: #000;font-size: 11px; margin-left: -10px;">Permission d'absence</span></a>

							<li id="item5"><a href="<?php echo base_url('control/lienCongeAnnuelAdmin'); ?>" ><img src="<?php echo(base_url('images/images-10.jpg')) ?>" title="Congé annuel" width="100px" height="100px"/><br><span style="color: #000;font-size: 11px; margin-left: -10px;">Congé annuel</span></a>
							
							<li id="item6"><a href="<?php echo base_url('control/lienpaterniteAdmin'); ?>" ><img src="<?php echo(base_url('images/images-1s.png')) ?>" title="Congé de paternité" width="100px" height="100px"/><br><span style="color: #000;font-size: 11px; margin-left: -10px;">Congé de paternité</span></a>

			                <li id="item2"><a href="<?php echo base_url('control/lienMaterniteAdmin'); ?>" ><img src="<?php echo(base_url('images/images-4.png')) ?>" title="Congé de maternité" width="100px" height="100px"/><br><span style="color: #000;font-size: 11px;margin-left: -10px; ">Congé de Maternité</span></a>
							</ul>
					</div>
			</div>

    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="" id="myFormEditValider">
          <input type="text" id="editId_paternV" name="id_patern">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="" id="myFormEditRejeter">
         <input type="text" name="id_patern" id="paternId_congeR">
        ...
        <div class="col-12">
          ...
          <div class="card" style="margin-top: -2%;border-color: red;">
            <div class="card-header">
              <h3 class="card-title">LISTE DE CONGE DE PATERNITE</h3>
        ...
        <div class="row mt-4">
            <nav class="w-150">
              <div class="nav nav-tabs" id="product-tab" role="tablist">
                <a class="nav-item nav-link active" id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true" style="font-size: 16px;font-style:;color: #717171;">Demande de congé de paternité</a>
...
$(document).ready(function() {
  loadTableEncours = $("#tabEncours").DataTable({
    'ajax': '<?php echo base_url();?>control/listeCongePaterniteEncours',
    'orders': [],
  }); 
});
...
$(document).ready(function() {
  loadTableValider = $("#tabValider").DataTable({
    'ajax': '<?php echo base_url();?>control/listeCongePaterniteValider',
    'orders': [],
  }); 
});
...
$(document).ready(function() {
  loadTableRejeter = $("#tabRejeter").DataTable({
    'ajax': '<?php echo base_url();?>control/listeCongePaterniteRejeter',
    'orders': [],
  }); 
});
...
function RejeterPaternitexx(id_patern = null) 
{
  if(id_patern) {
    $("#btnSupValiderOk").unbind('click').bind('click', function() {
      $.ajax({
        url: '<?php echo base_url();?>control/congePaterniteRejeter' + '/' + id_patern,
        type: 'post',       
        dataType: 'json',
...
function validerPaternite(id_patern = null) 
{
  if(id_patern) {

    $.ajax({
      url: '<?php echo base_url();?>control/selectpaterniteValider'+'/' + id_patern,
      type: 'post',
      dataType: 'json',
      success:function(response) {
        $("#editId_paternV").val(response.id_patern);
      }
    });
  }
  else {
...
function RejeterPaternite(id_patern = null) 
{
  if(id_patern) {

    $.ajax({
      url: '<?php echo base_url();?>control/selectPaterniteRejeter'+'/' + id_patern,
      type: 'post',
      dataType: 'json',
      success:function(response) {
        $("#paternId_congeR").val(response.id_patern);
      }
    });
  }
  else {
    alert('error');
        ...
        $('#myFormEditValider').attr('action','<?php echo base_url();?>control/congePaterniteValider');
    ...
    //modification
       ...
       $('#btnEditRejeter').click(function(){
        $('#myFormEditRejeter').attr('action','<?php echo base_url();?>control/congePaterniteRejeter');
        });

...
<body class="hold-transition sidebar-mini  layout-navbar-fixedxx" style="background-color: #f3f2ef">
<div class="wrapper" style="background-color: #f3f2ef">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-left: -20%;background-color: #f3f2ef">
<header >
      <div class="top" style="">
        <div class="container" >
          <div class="row">
            ...
            <div class="card-body" style="">
             ...
             <table  class="table table-head-fixed table-bordered" id="example1" style="font-size: 13px;border-color: #d3dce3,border: 2px">
                ...
                <tr style="color: #bb2839;border-color: #bb2839; background-color: #ccf987;">
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">N° décision</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Matricule</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Titre de congé</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Motif</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Nomdre de jours demandés</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Lieu de jouissance</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Date de congé</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Date de départ</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Date de retour</th>
                  <th style=" background:#f3f2ef;color: #000;border: 15px; ">Status</th>
                  <th style="width: 10%;background: #f4f6f9;color: #33514c;border: 15px; ">Actions</th>
                </tr>
                </thead>

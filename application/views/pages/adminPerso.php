             ...
             <div class="col-9">
              <input type="text" class="form-control" name="nom_perso" id="nom_perso" placeholder="Nom et prénom(s)">
               ...
               <div class="col-9">
                  <select class="form-control select2" style="width: 100%;" name="sexe_perso" id="sexe_perso">
                    <option value="" disabled selected="selected">Séléctionner votre sexe</option>
                    <option>M</option>
                    <option>F</option>  
                  </select>
                </div>
               ...
               <select class="form-control select2" style="width: 100%;" name="corps_perso" id="corps_perso">
                    <option value="" disabled selected="selected">Séléctionner votre corps</option>
              ...
              <div class="col-9">
                  <select class="form-control select2" style="width: 100%;" name="grade_perso" id="grade_perso">
                    <option value="" disabled selected="selected">Séléctionner votre grade</option>
               ...
               <div class="col-9">
                  <select class="form-control select2" style="width: 100%;" name="dir_perso" id="dir_perso">
                    <option value="" disabled selected="selected">Séléctionner votre direction</option>
                    <option>MIN</option>
                    <option>CAB</option>
                    <option>SG</option>
                    <option>DGFA</option>
                    <option>DGESFM</option>
                    <option>DGETP</option>
                    <option>DAAF</option>
                    <option>DRH</option>
                    <option>DPE</option>
                    ...
                    <option>DEPA</option>
                    <option>DCI</option>
                    <option>DEIPEF</option>
                    <option>DES</option>
                    <option>DFM</option>
                    <option>DERP</option>
                    <option>DERPES</option>
                    <option>DCAQ</option>
                    <option>DE</option>
                    <option>DETPQM</option>
                    <option>DEXAM</option>
                    <option>CNAPMAD</option>
                    <option>CFOI</option>
                    <option>OEMC</option>
               ...
               <!--Lieur de Service-->
               <div class="col-9">
                  <select class="form-control select2" style="width: 100%;" name="lieuserv_perso" id="lieuserv_perso">
                    <option value="" disabled selected="selected">Séléctionner votre lieu de service</option>
                    <option>SAF</option>
                    <option>SCEE</option>
                    <option>SAQ</option>
                    <option>SAG</option>
               ...
               <div class="col-9">
                ...
                <select class="form-control select2" style="width: 100%;" name="budget_perso" id="budget_perso">
                    <option value="" disabled selected="selected">Séléctionner votre budget</option>
            ...
            <div class="modal-body" style="background-color: #f4f6f9;">
             ...
             <!--Nom et prénom-->
              ...
              <div class="col-9">
               ...
               <!--Lieur de Service-->
                  <div class="col-9">
 <select class="form-control select2" style="width: 100%;" name="lieuserv_perso" id="editLieuService_perso">
                    <option value="" disabled selected="selected">Séléctionner votre lieu de service</option>
                    <option>SAF</option>
                    <option>SCEE</option>
                    <option>SAQ</option>
          ...
          <button title="Nouveau personnel" type="button" class="btn btn-flat" id ="btnModalx" data-toggle="modalx" data-target="#modal-overlay" style="background-color: #bb2839;border-color: #bb2839;margin-top: -5.2%;width: 11%; border-radius: 5px;">
            ...
            <div class="card-body">
             ...
             <table  class="table table-bordered" id="example1" style="font-size: 13px;">
                <thead>  
                <tr class="tabtr">
                  <th style=" background: #f3f2ef;color: #000">Matricule</th>
                  <th style=" background: #f3f2ef;color: #000">Nom et prénom(s)</th>
                  <th style=" background: #f3f2ef;color: #000">Sexe</th>
                  <th style=" background: #f3f2ef;color: #000">Corps</th>
                  <th style=" background: #f3f2ef;color: #000">Grade</th>
                  <th style=" background: #f3f2ef;color: #000">Direction</th>
                  <th style=" background: #f3f2ef;color: #000">Lieu de service</th>
                  <th style=" background: #f3f2ef;color: #000">Budget</th>
                  <th style=" background: #f3f2ef;color: #000">Chapitre budgetaire</th>
                  <th style=" background: #f3f2ef;color: #000">Actions</th>
                </tr>
      ...
      $.ajax({
        ...
        success:function(response) {
          if(response.success === true) {
            ...
            $("#deleteModalPerso").modal('hide');
             loadTable.ajax.reload(null, false); 
              toastr.succes('<b>Notification</b> </br>'+response.messages).show();
          }
    ...
    //modification
      $('#editBtnOk').on('click',function(){
       ...
       error: function(){
        ...
        $('#myFormEdit')[0].reset();
        loadTable.ajax.reload(null, false); 
       toastr.error('<b>Notification</b> </br>'+response.messages).show();
       }
       });

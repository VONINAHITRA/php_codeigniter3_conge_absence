...
<div class="lockscreen-wrapper" style="margin-top: 120px;">
  ...
  <!-- User name -->
  <div class="lockscreen-name"><?php echo $nomPre_perso; ?></div>
<br>
  ...
  <div class="lockscreen-item">
    ...
    <form  method="post" action="<?php echo base_url();?>control/accesAdmin" class="lockscreen-credentials">
      <div class="input-group">
      	<input type="hidden" name="im" value="<?php echo $im_user; ?>" class="form-control" placeholder="Im">
      	<input type="hidden" name="privi" value="<?php echo $privi_user; ?>" class="form-control" placeholder="Privi" >

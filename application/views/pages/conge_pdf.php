...
&nbsp;&nbsp;&nbsp;&nbsp;
NOMBRE DE JOURS DEMANDES :&nbsp;&nbsp; ".$infos->nbjrs_conge." Jours
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;
AU TITRE DE&nbsp;&nbsp; : ".$infos->titre_conge." <br><br>
&nbsp;&nbsp;&nbsp;&nbsp;
DU:&nbsp;&nbsp; ".$infos->dtdep_conge." 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
AU: &nbsp;&nbsp;".$infos->dtrtr_conge." <br><br>
&nbsp;&nbsp;&nbsp;&nbsp;
MOTIF:&nbsp;&nbsp; ".$infos->motif_conge." <br><br>
&nbsp;&nbsp;&nbsp;&nbsp;
LIEU DE JOUISSANCE :&nbsp;&nbsp; ".$infos->lieu_conge." <br><br><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;
...
- Décision d'octroi de congé n° :&nbsp;&nbsp;".$infos->numdec_conge."-MENETEP/SG/".$infos->direction_perso." du&nbsp;&nbsp;".$infos->dtdec_conge." <br><br>
- Droit de congé pour l'année:&nbsp;&nbsp;30&nbsp;jour(s) <br><br>
- Nombre de jours demandés:&nbsp;&nbsp;".$infos->nbjrs_conge."&nbsp;jour(s) <br><br>
- Nombre de jours restants:&nbsp;&nbsp;".$infos->nbjrs_conge."&nbsp;jour(s) <br><br>

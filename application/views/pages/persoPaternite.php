        ...
        <div class="modal-dialog modal-overlay" style="background-color:#bb2839; " >
          <div class="modal-content" >
            <div class="modal-header" style="background-color: #bb2839;height: 56.5px;">
              <h4 class="modal-title" style="margin-left: 0%;color: #fff;">Nouveau demande de congé de paternité</h4>
              ...
              <div class="col-9" style="margin-top: 3%;">
                <input type="hidden" class="form-control" value="<?php echo $im_perso; ?>" name="im_patern" id="im_patern" placeholder="Matricule" min="0" required>
              </div>
              <!--Nom et prénom-->
             <div class="col-9">

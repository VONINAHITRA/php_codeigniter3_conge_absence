         ...
         <br>
                ...
                <ul class="list-group list-group-unbordered mb-3" style="font-size: 16px;">
                  <li class="list-group-item">
                    <b>Pseudo: </b><br><a class="float-right"></a>
                  </li>
                  <li class="list-group-item">
                    <b>Email: </b> <br><a class="float-right"></a>
                  </li>
                  <li class="list-group-item">
                    <b>Téléphone: </b> <br><a class="float-right"></a>
                  </li>
                </ul>
          ...
          <div style="width:80%;margin-left: 19%;margin-top:-41%;float: right;">
          <div class="card" >
            ...
            <table  class="table table-head-fixed table-bordered" id="example1" style="font-size: 13px;width: 100%;text-align: center; ">
                ...
                <tr class="tabtrxx" style="background-color: #1b9a44">
                  ...
                  <th style=" background: #444444;color: #fff">Congé annuel</th>
                  <th style=" background: #444444;color: #fff"> Permission Absences</th>  
                  <th style=" background: #444444;color: #fff">Autorisation Absences</th>
                  <th style=" background: #444444;color: #fff">Année</th>  

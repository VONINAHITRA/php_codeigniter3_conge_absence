      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card" style="margin-top: -2%;border-color: red;">
            <div class="card-header">
              <h3 class="card-title">LISTE D'AUTORISATION D'ABSENCE</u></h3>
        ...
        <div class="row mt-4">
          ...
          <table  class="table table-bordered" id="tabEncours" style="font-size: 13px; width: 100%;">
              ...
              <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab" style="font-size: 13px; width: 100%;"> 
         <table  class="table table-bordered" id="tabValider" style="font-size: 13px; width: 100%;" >
              ...
              <div class="tab-pane fade" id="product-rating" role="tabpanel" aria-labelledby="product-rating-tab" style="font-size: 13px; width: 100%;">
...
$(document).ready(function() {
  loadTableEncours = $("#tabEncours").DataTable({
    'ajax': '<?php echo base_url();?>control/listeAutorisationEncours',
    'orders': [],
  }); 
});
...
$(document).ready(function() {
  loadTableValider = $("#tabValider").DataTable({
    'ajax': '<?php echo base_url();?>control/listeAutorisationValider',
    'orders': [],
  }); 
});
...
$(document).ready(function() {
  loadTableRejeter = $("#tabRejeter").DataTable({
    'ajax': '<?php echo base_url();?>control/listeAutorisationRejeter',
    'orders': [],
  }); 
});

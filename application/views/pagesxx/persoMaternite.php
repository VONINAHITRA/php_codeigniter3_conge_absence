          ...
          <div class="modal-content" >
            <div class="modal-header" style="background-color: #bb2839;height: 56.5px;">
              ...
              <div class="col-9" style="margin-top: 3%;">
                <input type="hidden" class="form-control" value="" name="im_matern" id="im_matern" placeholder="Matricule" required>
              </div>
              <!--Nom et prénom-->
             <div class="col-9">
...
<div class="modal fade" tabindex="-1" role="dialog" id="confirmeModal">
  ...
  <!-- removeMember -->
    ...
    <!-- Main content -->
    <section class="content" style="margin-left: 2%;margin-right: 2%;margin-top: 15%;">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <!-- /.card-header -->

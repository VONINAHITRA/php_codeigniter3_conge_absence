        ...
        <div class="modal-dialog modal-overlay" style="background-color:#bb2839; " >
          <div class="modal-content" >
            <div class="modal-header" style="background-color: #bb2839;height: 56.5px;">
              <h4 class="modal-title" style="margin-left: 0%;color: #fff;">Ajouter nouveau décision</h4>
              ...
              <div class="col-9" style="margin-top: 3%;">
                <input type="text" class="form-control" name="im_perso" placeholder="Matricule">
              </div>
              <!--Nom et prénom-->
             <div class="col-9">
              <input type="text" class="form-control" name="nom_perso" placeholder="Nom et prénom(s)">
             </div>
               <!--Sexe-->
               <div class="col-9">
              ...
              <div class="col-9">
               ...
               <!--Lieur de Service-->
                  <div class="col-9">
                    <input type="text" class="form-control" placeholder="Lieu de Service" name="lieuserv_perso">
                   </div>
               <!--Budget-->
               <div class="col-9">
               ...
               <!--Chapitre Budgetaire-->
               <div class="col-9"> 
                <input type="text" class="form-control" placeholder="Chapitre budgetaire" name="cbudget_perso">
               </div>
